...
result = canvas.Canvas("20CE015_RESULT.pdf")
...
result.drawString(30, 340, 'CA224')
result.drawString(100, 340, 'INTRODUCTION TO WEB DESIGNING')
...
result.drawString(510, 500, 'AA')  # JAVA THEORY GRADE
result.drawString(510, 480, 'BB')  # JAVA PRACTICAL GRADE

result.drawString(510, 460, 'AB')  # DE THEORY GRADE
result.drawString(510, 440, 'BC')  # DE PRACTICAL GRADE

result.drawString(510, 420, 'AB')  # DCN THEORY GRADE
result.drawString(510, 400, 'BB')  # DCN PRACTICAL GRADE

result.drawString(510, 380, 'AA')  # HS PRACTICAL GRADE

result.drawString(510, 340, 'AA')  # CA PRACTICAL GRADE
...
result.drawString(215, 230, '9.33')
...
result.drawString(445, 230, '9.08')

result.drawString(515, 270, 'Class')
result.drawString(500, 240, 'Distinction')

result.drawString(30, 200, 'Previous SGPA : 9.84')
result.drawString(230, 200, 'Previous CGPA : 8.92')
